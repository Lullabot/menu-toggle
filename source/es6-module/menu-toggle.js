 ...
 */
export const menuToggleAdjustMenuAndPageHeights = ($menuToggleTarget) => {
 ...
 */
export const menuToggleBackOut = (postShutCallback) => {
 ...
 * Toggle a given menu
 */
export const menuToggleToggleState = ($menuToggleButton, $menuToggleTarget, postOpenCallback, postShutCallback) => {
